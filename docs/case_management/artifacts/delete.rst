...
To delete Artifacts in bulk, refer to the `Delete Case Objects in Bulk <https://docs.threatconnect.com/en/latest/case_management/bulk_delete.html>`__ section in this documentation.
