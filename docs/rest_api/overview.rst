...
* ``/v2/indicators/{type}/{id}/indicators/addresses/{indicator}``
* ``/v2/indicators/{type}/{id}/indicators/emailAddresses``
* ``/v2/indicators/{type}/{id}/indicators/emailAddresses/{indicator}``
...
* ``/v2/indicators/{type}/{id}/indicators/files/{indicator}``
* ``/v2/indicators/{type}/{id}/indicators/hosts``
* ``/v2/indicators/{type}/{id}/indicators/hosts/{indicator}``
* ``/v2/indicators/{type}/{id}/indicators/urls``
* ``/v2/indicators/{type}/{id}/indicators/urls/{indicator}``
