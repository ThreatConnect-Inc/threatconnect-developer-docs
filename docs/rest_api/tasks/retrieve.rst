...
.. code::
    ...
    GET /v2/tasks/12345/indicators/addresses/54321

Where ``54321`` is the ID of an Address associated with Task 12345.
...
.. code::
    ...
    GET /v2/tasks/{taskId}/victimAssets/{associatedVictimAssetType}
