...
.. attention::
    ...
    Only API users with an Organization role of Organization Administrator can create, update, and delete users in their Organization. However, they may not perform these actions for users whose System role is **Administrator**, **Community Leader**, **Operations Administrator**, or **Super User**. API users with any other Organization role can only retrieve users in their Organization.
