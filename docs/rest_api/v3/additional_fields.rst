...
As of ThreatConnect version 7.12, artificial intelligence (AI) summaries may be generated for Document, Event, and Report Groups in ThreatConnect. Using the v3 API, you can retrieve a Group's AI summary, if one is available.
...
- ``insights``: Use this value if the Group has an AI summary generated by CAL Doc Analysis or Dataminr.
